...
const baseUrl = "https://dv1ji20wpb.execute-api.us-east-1.amazonaws.com/DESA/pocinstana/operacionsns";
...
class SNS extends Component {
    ...
    registroSNS=()=> {
        ...
        axios.post(baseUrl, {
            ...
            this.setState({ resultado: "ID del mensaje: " + response.data.idmessagesns })
        ...
        return(
            <div className="container">
                ...
                <div className="form-detalle">
                    ...
                    <div className="form-group">
                        <button className="btn btn-success" onClick={()=>this.registroSNS()}>Enviar comentario</button>
                    </div>
                    <div className="form-group">
